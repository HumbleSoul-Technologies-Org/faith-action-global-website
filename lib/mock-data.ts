...
export const empowermentArticles: Article[] = [
  {
    ...
    content: 'Women in the Bible demonstrate incredible strength and faith that transformed not only their lives but entire nations. Consider Ruth, a foreigner who chose loyalty and faith, becoming the great-grandmother of King David. Or Esther, who risked everything by appearing before the king uninvited to save her people, trusting God\'s providence.\n Deborah led Israel as a judge and prophetess, showing that faith-filled women can be mighty warriors for God. Rahab, a prostitute who believed in God\'s power, was saved from destruction and became an ancestor of Jesus himself.\n\n These women teach us that faith is more than just belief—it\'s action, courage, and trust in God\'s plan. \nTheir stories prove that when we place our faith in God, He honors our commitment and uses us for His purposes. This article explores how we can draw inspiration from their stories to empower ourselves and discover that having faith in God is truly worth it.',
  ...
  },
  {
    ...
    date: '2024-02-10',
    category: 'Leadership',
    content: 'Authentic leadership comes from serving others with genuine love and compassion, not from positions of power or authority. Leading with your heart means prioritizing the wellbeing of those you serve above personal gain. It\'s about listening with empathy, understanding the struggles of your community, and taking action rooted in faith and selfless service.\n\n Jesus exemplified this model of leadership through His humble service, washing His disciples\' feet and showing that true greatness comes through serving others. When you lead with your heart, you inspire others not through fear or manipulation, but through the authenticity of your character and your unwavering commitment to their growth. Heart-centered leaders create safe spaces where people feel valued, heard, and empowered to become the best versions of themselves. They practice vulnerability, admitting mistakes and learning from them, which builds trust and credibility.\n By leading with your heart, you don\'t just transform your community—you create a legacy of compassion, unity, and spiritual growth that extends far beyond your lifetime. Learn how to lead with your heart and unlock the transformative power of servant leadership in your community.',
  ...
  },
  {
    ...
    content: 'Fear often holds us back from pursuing our God-given gifts and stepping into our true potential. Whether it\'s fear of failure, rejection, inadequacy, or the unknown, these emotions can paralyze us and keep us from experiencing the abundant life God intends for us. The Bible repeatedly tells us "Fear not," reminding us that God has not given us a spirit of fear, but of power, love, and a sound mind. Breaking free from fear begins with recognizing its source—often rooted in past traumas, negative self-talk, or lack of faith in God\'s provision. \n\n One powerful strategy is to identify your specific fears and examine them honestly. Ask yourself: Is this fear based on reality, or am I catastrophizing? What would happen if I took this courageous step? Often, we discover that our fears are exaggerated versions of what might actually occur. Another essential practice is to replace fearful thoughts with truth. Memorize Scripture that speaks to your specific fear, meditate on God\'s promises, and speak affirmations of faith over your life. Surrounding yourself with a supportive community of believers provides accountability, encouragement, and practical guidance as you navigate your fears. \n\nTake small steps of courage—each time you act despite fear, you build confidence and prove to yourself that you can overcome. Finally, remember that courage isn\'t the absence of fear; it\'s taking action despite the fear. God promises to be with you in every circumstance, and His presence is greater than any fear you face. Discover practical strategies to overcome fear and embrace the life God has for you with confidence, faith, and unwavering trust in His love.',
...
export const events: Event[] = [
  ...
  },
  {
    ...
    image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ6yj24oYPNXNufOvnQbEnV-DFBF0TIEhoyeg&s',
    latitude: 0.3127974158609568,
    longitude: 32.58591811190712,
    views: 124,
    likes: 67,
